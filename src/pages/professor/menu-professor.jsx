...
import { FaHome, FaBookOpen, FaAddressBook, FaUsers, FaCog, FaUser, FaTasks } from "react-icons/fa";
  ...
  return (
    <aside className="h-screen w-64 bg-[#FFFFFF] text-[#444444] font-bold flex flex-col fixed left-0 top-0 shadow-lg z-30">
      ...
      <nav className="flex-1 flex flex-col gap-2 p-4">
        ...
        <Link to="/professor/arquivos-recebidos" className="flex items-center gap-2 py-2 px-4 rounded hover:bg-[#D3FFD2] hover:text-[#2F9E41] hover:font-bold transition">
          <FaCog /> Arquivos Recebidos
        </Link>
