          ...
          <div className="space-y-4">
            {editMode ? (
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-2">
                  <label className="font-semibold w-40 text-[#2F9E41]">Matrícula:</label>
                  <span className="text-gray-700">{form.matricula}</span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center gap-2">
                  <label className="font-semibold w-40 text-[#2F9E41]">Status:</label>
                  <span className="text-gray-700">{form.status}</span>
                </div>
                <div className="flex flex-col md:flex-row md:items-center gap-2">
                  <label className="font-semibold w-40 text-[#2F9E41]">Turma:</label>
                  <input
                    type="text"
                    name="turma"
                    value={form.turma || ""}
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-2">
                  <label className="font-semibold w-40 text-[#2F9E41]">Curso ID:</label>
